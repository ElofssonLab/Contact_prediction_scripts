...
def print_distances(contacts_x,
                    contacts_y,
                    scores,
                    dist_mat,
                    atom_seq_ali=[],
...
def get_ppv(fasta_filename,
    ...
    contacts = parse_contacts.parse(
        open(c_filename, 'r'), sep, min_dist=min_dist)
...
if __name__ == "__main__":
    ...
    p = argparse.ArgumentParser(
        description='Plot protein residue contact maps.')
